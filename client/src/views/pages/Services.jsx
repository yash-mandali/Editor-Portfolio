      ...
      <section className="container mx-auto px-6 mb-24 relative z-10">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-black mb-8 text-neutral-950 dark:text-white tracking-tighter leading-none transition-colors">
            EXPERTISE & <br /> <span className="text-neutral-300 dark:text-white/20 transition-colors">SERVICES</span>
          </h1>
        ...
        >
          {SERVICES.map((service) => (
            <motion.div
              ...
              whileHover={{ y: -10 }}
              className="bg-neutral-50 dark:bg-neutral-900/50 backdrop-blur-xl border border-black/5 dark:border-neutral-800 p-10 rounded-none hover:border-amber-500/30 transition-all group shadow-sm hover:shadow-2xl relative overflow-hidden"
            >
